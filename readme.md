...
####8
    ...
    Turn that JSON string back into an object by using JSON.parse and save that in another hash that we'll call params (again because this is what Rails does). Your code might look like 
